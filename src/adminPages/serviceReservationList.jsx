...
import CancelServiceReservationModal from "../components/cancelServiceReservationModal";
import ViewServiceReservationModal from "../components/viewServiceReservationModal";

function AdminServiceReservationList() {
    ...
    const fetchReservations = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:5000/admin/service-reservations"
        );
          ...
          {filteredReservations.length > 0 ? (
            filteredReservations.map((reservation) => (
              <tr key={reservation.id}>
                ...
                <td style={tdStyle}>{reservation.service_name}</td>
                <td style={tdStyle}>
...
export default AdminServiceReservationList;
